 ...
 * .select()
 * .apis(RequestHandlerSelectors.basePackage("com.emp.bonous.Controller"))
 * .paths(PathSelectors.any()) .build() .apiInfo(apiInfo()); }
 * 
 * private ApiInfo apiInfo() { return new ApiInfoBuilder()
 * .title("Your API Title")
 * .description("API documentation for your application") .version("1.0")
 * .build(); } public SwaggerConfig() {
 * LOGGER.debug("SwaggerConfig initialized."); } }
 * 
 */